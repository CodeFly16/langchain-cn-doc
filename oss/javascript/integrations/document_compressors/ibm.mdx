...
description: "使用 LangChain JavaScript 集成 IBM watsonx.ai document compressor。"
---
...
要访问 IBM WatsonxAI models，你需要create an IBM watsonx.ai account, get an API key or any other type of credentials, and install the `@langchain/community` integration package.
...
有关所有 Watsonx document compressor 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-community/document_compressors/ibm/WatsonxRerank)。
...
<Callout icon="edit">
        [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/document_compressors/ibm.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
