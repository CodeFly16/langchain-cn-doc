...
description: "使用 LangChain JavaScript 集成 TogetherAIEmbeddings embedding model。"
---
...
要访问 TogetherAI embedding models，你需要create a TogetherAI account, get an API key, and install the `@langchain/community` integration package.
...
<Callout icon="edit">
        [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/embeddings/togetherai.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
