---
title: "PineconeEmbeddings 集成"
description: "使用 LangChain JavaScript 集成 PineconeEmbeddings embedding model。"
---
...
要访问 Pinecone embedding models，你需要create a Pinecone account, get an API key, and install the `@langchain/pinecone` integration package.
...
LangChain 的 PineconeEmbeddings 集成位于 `@langchain/pinecone` 包中：
...
有关所有 `PineconeEmbeddings` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-pinecone/PineconeEmbeddings)。
...
<Callout icon="edit">
        [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/embeddings/pinecone.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
