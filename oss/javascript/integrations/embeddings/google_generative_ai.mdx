...
description: "使用 LangChain JavaScript 集成 GoogleGenerativeAIEmbeddings embedding model。"
---
...
要访问 Google Generative AI embedding models，你需要sign up for a Google AI account, get an API key, and install the `@langchain/google-genai` integration package.
...
<Callout icon="edit">
        [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/embeddings/google_generative_ai.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
