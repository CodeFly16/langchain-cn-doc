---
title: "VertexAIEmbeddings 集成"
description: "使用 LangChain JavaScript 集成 VertexAIEmbeddings embedding model。"
---
...
要访问 `ChatVertexAI` models，你需要setup Google VertexAI in your Google Cloud Platform (GCP) account, save the credentials file, and install the `@langchain/google-vertexai` integration package.
...
有关所有 `VertexAIEmbeddings` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-google-vertexai/index/VertexAIEmbeddings)。
...
<Callout icon="edit">
        [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/embeddings/google_vertex_ai.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
