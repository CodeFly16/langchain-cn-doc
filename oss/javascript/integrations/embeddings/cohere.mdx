...
description: "使用 LangChain JavaScript 集成 CohereEmbeddings embedding model。"
---
...
要访问 Cohere embedding models，你需要create a Cohere account, get an API key, and install the `@langchain/cohere` integration package.
...
<Callout icon="edit">
        [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/embeddings/cohere.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
