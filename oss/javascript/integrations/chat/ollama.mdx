---
title: "ChatOllama 集成"
description: "使用 LangChain JavaScript 集成 ChatOllama chat model。"
---
...
本指南将帮助你开始使用 `ChatOllama` [chat models](/oss/javascript/langchain/models)。有关所有 `ChatOllama` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-ollama/ChatOllama)。
