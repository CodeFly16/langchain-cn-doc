...
sidebarTitle: "聊天"
description: "使用 LangChain JavaScript 集成 ChatAnthropic chat model。"
---

[Anthropic](https://www.anthropic.com/) 是一家 AI 安全与研究公司，是 Claude 的创造者。
...
你需要注册并获取 [Anthropic API key](https://www.anthropic.com/)，并安装 `@langchain/anthropic` 集成包。

### 凭证

前往 [Anthropic's website](https://www.anthropic.com/) 注册 Anthropic 并生成 API 密钥。完成后设置 `ANTHROPIC_API_KEY` 环境变量：
...
<Callout icon="edit">
        [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/chat/anthropic.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
