---
title: "ChatCohere 集成"
description: "使用 LangChain JavaScript 集成 ChatCohere chat model。"
---
...
前往 [Cohere's website](https://dashboard.cohere.com/welcome/register) 注册 Cohere 并生成 API 密钥。完成后设置 `COHERE_API_KEY` 环境变量：
