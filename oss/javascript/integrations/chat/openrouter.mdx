...
sidebarTitle: "聊天"
description: "使用 LangChain JavaScript 集成 ChatOpenRouter chat model。"
---
...
要访问 models via OpenRouter，你需要create an [OpenRouter account](https://openrouter.ai/), get an API key, and install the `@langchain/openrouter` integration package.
...
<Callout icon="edit">
        [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/chat/openrouter.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
