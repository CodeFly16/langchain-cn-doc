...
description: "使用 LangChain JavaScript 集成 WebPDFLoader document loader。"
---
...
要访问 `WebPDFLoader` document loader，你需要install the `@langchain/community` integration, along with the `pdf-parse` package:
...
LangChain 的 WebPDFLoader 集成位于 `@langchain/community` 包中：
...
<Callout icon="edit">
        [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/document_loaders/web_loaders/pdf.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
