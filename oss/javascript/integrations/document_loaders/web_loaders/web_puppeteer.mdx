...
description: "使用 LangChain JavaScript 集成 PuppeteerWebBaseLoader document loader。"
---
...
要访问 `PuppeteerWebBaseLoader` document loader，你需要install the `@langchain/community` integration package, along with the `puppeteer` peer dependency.
...
<Callout icon="edit">
        [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/document_loaders/web_loaders/web_puppeteer.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
