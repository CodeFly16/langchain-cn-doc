...
有关更多信息，请参阅 [the complete middleware guide](/oss/javascript/langchain/middleware).
...
有关更多信息，请参阅 our guide on [content blocks](/oss/javascript/langchain/messages#message-content)
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/releases/langchain-v1.mdx) or [提交 Issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
