...
请参阅 following tutorial to build a searchable knowledge base and minimal RAG workflow:
...
>
    ...
    在本教程中, you’ll build a search engine over a PDF, enabling retrieval of passages relevant to a query. You’ll also implement a minimal RAG workflow on top of this engine to see how external knowledge can be integrated into LLM reasoning.
</Card>
