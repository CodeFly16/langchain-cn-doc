...
<Tip>
During streaming, keep the ThinkingBubble collapsed 默认情况下 and show only the spinner. Expanding mid-stream can cause layout jitter as new tokens arrive. Let users expand after the reasoning phase completes.
</Tip>
