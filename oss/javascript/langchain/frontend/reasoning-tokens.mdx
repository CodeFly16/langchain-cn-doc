---
title: 推理 Token
description: 在可折叠区块中展示模型的思考和推理过程
---

推理 Token 揭示了高级模型（如 OpenAI 的 o1/o3 和 Anthropic 的 Claude 扩展思考功能）的内部思考过程。这些模型生成结构化的内容块，将推理与最终答案分离，让你能够构建展示模型*如何*得出响应的 UI 界面。
