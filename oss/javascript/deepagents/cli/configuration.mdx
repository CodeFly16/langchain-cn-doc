...
title: 配置
sidebarTitle: 配置
description: 使用 config.toml、hooks 和 MCP 服务器配置深度智能体 CLI
---
...
管理器列出 CLI 已知的每个大语言模型（LLM）提供商, marks the ones that already have a key, and lets you paste, rotate, or clear credentials inline. Each provider renders as one of:
