...
你可以使用 [skills](/oss/javascript/deepagents/skills) to provide your deep agent with new capabilities and expertise.
...
<Steps>
    ...
    <Step title="Add 可选 resources">
        Optionally add additional scripts or other resources to the `test-skill` folder. 更多信息请参阅 [Examples](/oss/javascript/deepagents/skills#example).
    </Step>
</Steps>

你也可以 copy existing skills directly to the agent's folder:
...
你可以使用 tools like Vercel's [Skills CLI](https://github.com/vercel-labs/skills) to install community [Agent Skills](https://agentskills.io/) in your environment and make them available to your deep agents:
...
你也可以 invoke a skill directly with `/skill:<name> [args]`. Skill discovery runs at startup and again on `/reload`.
