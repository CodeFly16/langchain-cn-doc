...
read the [**streaming guide**](/oss/javascript/langgraph/streaming) section 了解更多详情.
...
Short-term memory allows storing information across different **invocations** of the same **thread id**. See [short-term memory](/oss/javascript/langgraph/functional-api#short-term-memory) 了解更多详情.
