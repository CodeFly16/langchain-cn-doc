...
[LangChain 前端模式](/oss/javascript/langchain/frontend/overview)——Markdown 消息、工具调用、乐观更新等——适用于任何 LangGraph 图。`useStream` hook 无论你使用 `createAgent`、`createDeepAgent` 还是自定义 `StateGraph`，都提供相同的核心 API。
