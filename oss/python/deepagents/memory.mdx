...
This is useful for agents that perform complex, multi-step tasks. 例如， a coding agent can look back at a past debugging session and skip straight to the likely root cause.
