...
以下使用 LangGraph 的公司及其成功案例列表来源于公开资料。如果你的公司正在使用 LangGraph，我们非常欢迎你分享你的故事并将其添加到列表中。你也可以根据其他公司的公开信息（如博客文章或新闻稿）贡献更新。

| 公司 | 行业 | 使用场景 | 参考资料 |
| --- | --- | --- | --- |
| [AirTop](https://www.airtop.ai/) | 软件与技术（GenAI 原生） | AI 智能体的浏览器自动化 | [案例研究, 2024](https://blog.langchain.dev/customers-airtop/) |
| [AppFolio](https://www.appfolio.com/) | 房地产 | 领域专用任务的 Copilot | [案例研究, 2024](https://blog.langchain.dev/customers-appfolio/) |
...
| [BlackRock](https://www.blackrock.com/) | 金融服务 | 领域专用任务的 Copilot | [Interrupt 演讲, 2025](https://youtu.be/oyqeCHFM5U4?feature=shared) |
...
| [City of Hope](https://www.cityofhope.org/) | 非营利组织 | 领域专用任务的 Copilot | [视频故事, 2025](https://youtu.be/9ABwtK2gIZU?feature=shared) |
| [C.H. Robinson](https://www.chrobinson.com/en-us/) | 物流 | 自动化 | [案例研究, 2025](https://blog.langchain.dev/customers-chrobinson/) |
| [Definely](https://www.definely.com/) | 法律 | 领域专用任务的 Copilot | [案例研究, 2025](https://blog.langchain.com/customers-definely/) |
| [Docent Pro](https://docentpro.com/) | 旅游 | GenAI 嵌入式产品体验 | [案例研究, 2025](https://blog.langchain.com/customers-docentpro/) |
| [Elastic](https://www.elastic.co/) | 软件与技术 | 领域专用任务的 Copilot | [博客文章, 2025](https://www.elastic.co/blog/elastic-security-generative-ai-features) |
...
| [J.P. Morgan](https://www.jpmorganchase.com/) | 金融服务 | 领域专用任务的 Copilot | [Interrupt 演讲, 2025](https://youtu.be/yMalr0jiOAc?feature=shared) |
| [Klarna](https://www.klarna.com/) | 金融科技 | 领域专用任务的 Copilot | [案例研究, 2025](https://blog.langchain.dev/customers-klarna/) |
| [Komodo Health](https://www.komodohealth.com/) | 医疗健康 | 领域专用任务的 Copilot | [博客文章](https://www.komodohealth.com/perspectives/new-gen-ai-assistant-empowers-the-enterprise/) |
...
| [OpenRecovery](https://www.openrecovery.com/) | 医疗健康 | 领域专用任务的 Copilot | [案例研究, 2024](https://blog.langchain.dev/customers-openrecovery/) |
...
| [Rakuten](https://www.rakuten.com/) | 电子商务 / 金融科技 | 领域专用任务的 Copilot | [视频故事, 2025](https://youtu.be/gD1LIjCkuA8?feature=shared); [博客文章, 2025](https://rakuten.today/blog/from-ai-hype-to-real-world-tools-rakuten-teams-up-with-langchain.html) |
| [Replit](https://replit.com/) | 软件与技术 | 代码生成 | [博客文章, 2024](https://blog.langchain.dev/customers-replit/); [突破性智能体故事, 2024](https://www.langchain.com/breakoutagents/replit); [炉边对话视频, 2024](https://www.youtube.com/watch?v=ViykMqljjxU) |
| [Rexera](https://www.rexera.com/) | 房地产（GenAI 原生） | 领域专用任务的 Copilot | [案例研究, 2024](https://blog.langchain.dev/customers-rexera/) |
| [阿布扎比政府](https://www.tamm.abudhabi/) | 政府 | 搜索 | [案例研究, 2025](https://blog.langchain.com/customers-abu-dhabi-government/) |
| [Tradestack](https://www.tradestack.uk/) | 软件与技术（GenAI 原生） | 领域专用任务的 Copilot | [案例研究, 2024](https://blog.langchain.dev/customers-tradestack/) |
...
| [Unify](https://www.unifygtm.com/) | 软件与技术（GenAI 原生） | 领域专用任务的 Copilot | [Interrupt 演讲, 2025](https://youtu.be/pKk-LfhujwI?feature=shared); [博客文章, 2024](https://blog.langchain.dev/unify-launches-agents-for-account-qualification-using-langgraph-and-langsmith/) |
| [Vizient](https://www.vizientinc.com/) | 医疗健康 | 领域专用任务的 Copilot | [视频故事, 2025](https://www.youtube.com/watch?v=vrjJ6NuyTWA); [案例研究, 2025](https://blog.langchain.dev/p/3d2cd58c-13a5-4df9-bd84-7d54ed0ed82c/) |
