...
* **Tool semantics**: Clarify whether handoff tools only update routing state or also perform side effects. 例如， should `transfer_to_sales()` also create a support ticket, or should that be a separate action?
