...
See the [common patterns](#common-patterns) section below for additional 端到端 examples.
...
例如， if you have an agent that calls a tool once, you should see the following updates:
