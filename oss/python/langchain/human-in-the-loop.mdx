...
人机协作（HITL）[中间件](/oss/python/langchain/middleware/built-in#human-in-the-loop)让你可以为智能体的工具调用添加人工监督。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/langchain/human-in-the-loop.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
