---
title: "Nebius 集成"
description: "使用 LangChain Python 集成 Nebius 向量嵌入模型。"
---

[Nebius Token Factory](https://tokenfactory.nebius.com/) 提供对 high-quality 向量嵌入模型 through a unified 接口。 The Nebius 向量嵌入模型 convert text into numerical vectors that capture semantic meaning, making them useful for various applications like semantic search, clustering, and recommendations.
