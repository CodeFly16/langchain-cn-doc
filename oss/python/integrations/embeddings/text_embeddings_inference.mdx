...
description: "使用 LangChain Python 集成 Text embeddings inference 向量嵌入模型。"
---
...
Then expose an embedding model using TEI. 例如， using Docker, you can serve `BAAI/bge-large-en-v1.5` as follows:
