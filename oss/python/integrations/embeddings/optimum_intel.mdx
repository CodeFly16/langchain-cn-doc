---
title: "Embedding documents using optimized and quantized embedders 集成"
description: "使用 LangChain Python 集成 Embedding documents using optimized and quantized embedders 向量嵌入模型。"
---
