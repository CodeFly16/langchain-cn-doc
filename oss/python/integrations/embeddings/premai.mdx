---
title: "Premai 集成"
description: "使用 LangChain Python 集成 Premai 向量嵌入模型。"
---
...
We support lots of state of the art 向量嵌入模型. You can view our [list of supported LLMs and 向量嵌入模型](https://docs.premai.io/get-started/supported-models). For now let's go for `text-embedding-3-large` model for this example.
