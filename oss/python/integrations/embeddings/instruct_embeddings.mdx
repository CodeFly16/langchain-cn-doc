---
title: "Instructor embeddings on Hugging Face 集成"
description: "使用 LangChain Python 集成 Instructor-style 向量嵌入模型 on Hugging Face 。"
---

>The `hkunlp/instructor-*` family introduced instruction-tuned sentence embeddings. They have been broadly superseded by modern instruction-aware models, but the original models are still available on Hugging Face and usable 通过 legacy `HuggingFaceInstructEmbeddings` class.
