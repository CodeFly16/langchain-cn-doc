...
description: "使用 LangChain Python 集成 OpenAIEmbeddings 向量嵌入模型。"
---

本指南将帮助您开始使用 OpenAI 向量嵌入模型 using LangChain. For detailed documentation on `OpenAIEmbeddings` 功能和配置选项的详细文档，请参阅 [API reference](https://reference.langchain.com/python/langchain-openai/embeddings/base/OpenAIEmbeddings).
...
前往 [platform.openai.com](https://platform.openai.com) 注册 OpenAI 并生成 API 密钥。 Once you’ve done this set the OPENAI_API_KEY 环境变量：
...
For detailed documentation on `OpenAIEmbeddings` 功能和配置选项的详细文档，请参阅 [API reference](https://reference.langchain.com/python/langchain-openai/embeddings/base/OpenAIEmbeddings).
