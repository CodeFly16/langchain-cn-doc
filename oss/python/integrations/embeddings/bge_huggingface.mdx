...
description: "使用 LangChain Python 集成 BGE 向量嵌入模型 on Hugging Face 。"
---
...
For reranking (not embedding), see [`BAAI/bge-reranker-v2-m3`](https://huggingface.co/BAAI/bge-reranker-v2-m3) 通过 [Cross Encoder Reranker guide](/oss/python/integrations/document_transformers/cross_encoder_reranker).

## More

请参阅 [Sentence Transformers integration page](/oss/python/integrations/embeddings/sentence_transformers) for GPU configuration, batch sizes, query/document prompts, and deployment options.
