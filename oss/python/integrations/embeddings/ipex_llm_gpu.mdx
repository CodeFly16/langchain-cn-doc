---
title: "IPEX-LLM local BGE embeddings on Intel GPU 集成"
description: "使用 LangChain Python 集成 IPEX-LLM local BGE embeddings on Intel GPU 向量嵌入模型。"
---
...
>
> For other GPU types, 请参阅 [IPEX-LLM Windows runtime configuration](https://github.com/intel-analytics/ipex-llm/blob/main/docs/mddocs/Overview/install_gpu.md#runtime-configuration) or [IPEX-LLM Linux runtime configuration](https://github.com/intel-analytics/ipex-llm/blob/main/docs/mddocs/Overview/install_gpu.md#runtime-configuration-1).
