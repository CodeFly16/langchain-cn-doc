---
title: "Jina 集成"
description: "使用 LangChain Python 集成 Jina 向量嵌入模型。"
---

You can check the [list of available Jina 向量嵌入模型](https://jina.ai/embeddings/).
...
## Embed text and queries with jina 向量嵌入模型 through JinaAI API
