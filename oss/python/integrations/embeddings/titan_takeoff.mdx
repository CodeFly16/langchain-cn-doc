...
description: "使用 LangChain Python 集成 Titan takeoff 向量嵌入模型。"
---

`TitanML` helps businesses build and deploy better, smaller, cheaper, and faster NLP models through our training, compression, and inference optimization platform.

Our inference server, [Titan Takeoff](https://docs.titanml.co/docs/intro) enables deployment of LLMs locally on your hardware in a single command. Most 向量嵌入模型 are supported out of the box, if you experience trouble with a specific model, please let us know at [hello@titanml.co](mailto:hello@titanml.co).
