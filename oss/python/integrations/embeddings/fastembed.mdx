...
description: "使用 LangChain Python 集成 FastEmbed by Qdrant 向量嵌入模型。"
---
...
- `model_name: str` (default: "BAAI/bge-small-en-v1.5")
        > Name of the FastEmbedding model to use. 请参阅 [list of supported FastEmbed models](https://qdrant.github.io/fastembed/examples/Supported_Models/).
