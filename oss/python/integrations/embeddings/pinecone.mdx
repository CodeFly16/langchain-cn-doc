---
title: "Pinecone 集成"
description: "使用 LangChain Python 集成 Pinecone 向量嵌入模型。"
---

Pinecone's inference API can be accessed via `PineconeEmbeddings`. Providing text embeddings 通过 Pinecone service. We start by installing prerequisite libraries:
