---
title: "Isaacus 集成"
description: "使用 LangChain Python 集成 Isaacus 向量嵌入模型。"
---
...
Now that your account is set up, install the [Isaacus LangChain](https://pypi.org/project/langchain-isaacus/) 集成包。
