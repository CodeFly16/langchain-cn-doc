---
title: "Textembed - embedding inference server 集成"
description: "使用 LangChain Python 集成 Textembed - embedding inference server 向量嵌入模型。"
---

TextEmbed is a high-throughput, low-latency REST API designed for serving vector embeddings. It supports 各种 sentence-transformer models and frameworks, making it suitable for various applications in natural language processing.
...
For more information, please 阅读 [documentation](https://github.com/kevaldekivadiya2415/textembed/blob/main/docs/setup.md).
