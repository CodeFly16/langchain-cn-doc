...
description: "使用 LangChain Python 集成 NomicEmbeddings 向量嵌入模型。"
---

本指南将帮助您开始使用 Nomic 向量嵌入模型 using LangChain. For detailed documentation on `NomicEmbeddings` 功能和配置选项的详细文档，请参阅 [API reference](https://reference.langchain.com/python/langchain-nomic/embeddings/NomicEmbeddings).
...
For detailed documentation on `NomicEmbeddings` 功能和配置选项的详细文档，请参阅 [API reference](https://reference.langchain.com/python/langchain-nomic/embeddings/NomicEmbeddings).
