---
title: "LangSmith LLM runs 集成"
description: "使用 LangChain Python 集成 LangSmith LLM runs。"
---

This notebook 演示如何 directly load data from LangSmith's LLM runs and fine-tune a model on that data.
