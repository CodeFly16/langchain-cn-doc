---
title: "Gmail 集成"
description: "使用 LangChain Python 集成 Gmail。"
---
...
请注意 there are clear limitations here. 例如, all examples created are only looking at the previous email for context.

To use:

- Set up a Google Developer Account: 前往 Google Developer Console, create a project, and enable the Gmail API for that project. This will give you a credentials.json file that you'll need later.
