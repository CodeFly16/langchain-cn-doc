...
本页面涵盖了 LangChain 与[Open Agent Specification](https://oracle.github.io/agent-spec).

Open Agent Spec is a framework-agnostic declarative language from Oracle for defining agentic systems. 它允许 to define agents and workflows in a portable JSON/YAML format that can be executed across different runtimes.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/open_agent_spec.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
