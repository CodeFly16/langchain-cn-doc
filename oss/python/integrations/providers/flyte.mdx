...
> [Flyte](https://github.com/flyteorg/flyte) 是一个开源的 orchestrator that facilitates building production-grade data and ML pipelines.
...
Title: {title}
Playwright: 这是一个 synopsis for the above play:"""
    llm = ChatOpenAI(
        model_name="gpt-3.5-turbo",
        temperature=0,
        callbacks=[FlyteCallbackHandler()],
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/flyte.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
