---
title: "Tencent 集成"
description: "使用 LangChain Python 与 Tencent 集成。"
---
...
> command line tool, and graphical tools. 它可以 well with Amazon S3 APIs, allowing you to quickly
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/tencent.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
