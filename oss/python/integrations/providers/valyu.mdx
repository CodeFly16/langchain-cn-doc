...
This notebook goes over how to use Valyu在 LangChain 中。
...
The integration lives in the `langchain-valyu` 包。
...
您可以使用 [`ValyuContextRetriever`](https://pypi.org/project/langchain-valyu/) in a standard retrieval pipeline.
...
您可以使用 `ValyuSearchTool` for advanced search queries.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/valyu.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
