...
- To run everything locally, install the open-source Python 包 with `pip install unstructured`
...
查看[使用示例](/oss/python/integrations/document_loaders/unstructured_file) to see how you can use
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/unstructured.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
