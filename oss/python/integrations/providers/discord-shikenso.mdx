...
Below is a snippet showing how you can read and send messages in Discord. 有关更多详情，请参阅 the [documentation for Discord tools](/oss/python/integrations/tools/discord).
