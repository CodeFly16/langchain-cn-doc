---
title: "Identity-enabled RAG using pebbloretrievalqa 集成"
description: "使用 LangChain Python 与 Identity-enabled RAG using pebbloretrievalqa 集成。"
---
...
有关更多详情，请参阅Pebblo and its SafeRetriever feature visit [Pebblo documentation](https://daxa-ai.github.io/pebblo/retrieval_chain/)
...
此外，the company maintained a conservative debt-to-equity ratio of 0.5, ensuring sustainable financial stability.
...
prompt_template = PromptTemplate.from_template(
    """
Answer the question 使用 provided context.
...
因此，an app that denies the `financial-report` topic should not receive an answer.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/pebblo/pebblo_retrieval_qa.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
