...
> 它提供 a distributed, multi-tenant-capable full-text search engine with an HTTP web interface and schema-free
> JSON documents.
...
The easiest way to run Elasticsearch locally for development and testing is 使用 [start-local](https://github.com/elastic/start-local) script. This script sets up Elasticsearch using Docker with a simple one-line command.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/elasticsearch.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
