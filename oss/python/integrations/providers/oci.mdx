...
本页面涵盖了 LangChain 与[Oracle Cloud Infrastructure (OCI)](https://www.oracle.com/cloud/).
...
> Oracle Cloud Infrastructure (OCI) [Generative AI](https://docs.oracle.com/en-us/iaas/Content/generative-ai/home.htm) 是一项完全托管的服务 that provides a set of state-of-the-art, customizable large language models (LLMs) that cover a wide range of use cases, and which are available through a single API.
...
查看[使用示例](/oss/python/integrations/chat/oci_generative_ai).
...
查看[使用示例](/oss/python/integrations/embeddings/oci_generative_ai).
...
> [OCI Data Science](https://docs.oracle.com/en-us/iaas/data-science/using/home.htm) is a fully managed and serverless platform for data science teams. Deploy custom models as endpoints 使用 [OCI Data Science Model Deployment Service](https://docs.oracle.com/en-us/iaas/data-science/using/model-dep-about.htm).

### ChatOCIModelDeployment

Chat model for OCI Data Science Model Deployments.

查看[使用示例](/oss/python/integrations/chat/oci_data_science).
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/oci.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
