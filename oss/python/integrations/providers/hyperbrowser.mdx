...
请确保to get your API Key from https://app.hyperbrowser.ai/
...
您可以查看 more details in the [Hyperbrowser browser agent tools guide](/oss/python/integrations/tools/hyperbrowser_browser_agent_tools)
...
Here is a brief description of the Web Scraping Tools available with Hyperbrowser. 您可以查看 more details in the [Hyperbrowser web scraping tools guide](/oss/python/integrations/tools/hyperbrowser_web_scraping_tools).
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/hyperbrowser.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
