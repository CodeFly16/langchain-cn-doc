...
## 安装和设置
- Create a [Replicate](https://replicate.com) account. 获取您的 API 密钥 and set it as an environment variable (`REPLICATE_API_TOKEN`)
...
*请注意，only the first output of a model will be returned.*
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/replicate.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
