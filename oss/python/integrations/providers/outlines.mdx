...
>[Outlines](https://github.com/dottxt-ai/outlines) is a Python 库 for constrained language generation. 它提供 a unified interface to various language models and allows for structured generation using techniques like regex matching, type constraints, JSON schemas, and context-free grammars.
...
此集成 allows you to use Outlines models with LangChain, providing both LLM and chat model interfaces.
...
- `"vllm"`: For models 使用 vLLM library
- `"mlxlm"`: For models 使用 MLX framework
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/outlines.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
