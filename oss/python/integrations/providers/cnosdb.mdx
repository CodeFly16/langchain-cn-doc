...
> [CnosDB](https://github.com/cnosdb/cnosdb) 是一个开源的 distributed time series database with high performance, high compression rate and high ease of use.
...
You can connect to CnosDB 使用 `SQLDatabase.from_cnosdb()` method.
### Syntax
```python
