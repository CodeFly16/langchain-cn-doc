---
title: "Weights & Biases tracking 集成"
description: "使用 LangChain Python 与 Weights & Biases tracking 集成。"
---
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/wandb_tracking.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
