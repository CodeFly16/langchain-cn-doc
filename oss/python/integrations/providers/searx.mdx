---
title: "SearxNG search API 集成"
description: "使用 LangChain Python 与 SearxNG search API 集成。"
---
...
您可以使用 wrapper to get results from a SearxNG instance.
...
请注意，we could _optionally_ pass custom engines to use.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/searx.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
