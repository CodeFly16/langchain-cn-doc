...
本指南提供了开始使用 Amazon Nova [聊天模型](/oss/python/langchain/models). Amazon Nova models are OpenAI-compatible and accessed 通过 OpenAI SDK pointed at Nova's endpoint, providing seamless integration with LangChain's standard interfaces. The Amazon Nova API is free tier with rate limits.
...
<Tip>
    **API 参考**
    ...
    有关所有 [`ChatAmazonNova`](https://reference.langchain.com/python/langchain-amazon-nova/chat_models/ChatAmazonNova) features and configuration options, 请前往 [`ChatAmazonNova`](https://reference.langchain.com/python/langchain-amazon-nova/chat_models/ChatAmazonNova) API reference.

    For Amazon Nova model details and capabilities, 请参阅 [Amazon Nova documentation](https://nova.amazon.com/dev/documentation).
</Tip>
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | 模型-dependent | ❌ | 模型-dependent (Nova 2) | ✅ | ✅ | ✅ | ❌ |

## 设置

要访问 Amazon Nova models, you'll need to [obtain API credentials](https://nova.amazon.com/dev) and install the [`langchain-amazon-nova`](https://reference.langchain.com/python/langchain-amazon-nova/) 集成包。
...
<Info>
    For a complete list of supported parameters and their descriptions, 请参阅 [Amazon Nova documentation](https://nova.amazon.com/dev/documentation).
</Info>
...
<Info>
    For details on Nova's tool calling implementation and available parameters, 请参阅 [tool calling documentation](https://nova.amazon.com/dev/documentation).
</Info>
...
Amazon Nova supports controlling when the model should use tools 通过 `tool_choice` parameter:
...
<Info>
    **Tool outputs and citations**
    ...
    当使用 system tools, the model's response will include:
...
For complete details on system tools, their parameters, and capabilities, 请参阅 [Amazon Nova documentation](https://nova.amazon.com/dev/documentation).
...
<Info>
    **Model capabilities vary by model**
    ...
    For a complete list of available models and their capabilities, 请参阅 [Amazon Nova documentation](https://nova.amazon.com/dev/documentation).
</Info>
...
有关所有 [`ChatAmazonNova`](https://reference.langchain.com/python/langchain-amazon-nova/chat_models/ChatAmazonNova) 功能和配置的详细文档，请前往 [`ChatAmazonNova`](https://reference.langchain.com/python/langchain-amazon-nova/chat_models/ChatAmazonNova) API reference.

For Amazon Nova-specific features, model details, and API specifications, 请参阅 [Amazon Nova documentation](https://nova.amazon.com/dev/documentation).
