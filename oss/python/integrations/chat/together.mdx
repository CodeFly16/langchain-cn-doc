...
本页面将帮助您开始使用 Together AI [聊天模型](/oss/python/langchain/models). 有关所有 `ChatTogether` 功能和配置的详细文档，请前往 [API reference](https://reference.langchain.com/python/langchain-together/chat_models/ChatTogether).
...
前往 [this page](https://api.together.ai) 注册 Together 并生成 API 密钥。 完成后，设置 TOGETHER_API_KEY 环境变量：
...
LangChain 的 Together integration is included in the `langchain-together` 包中：
...
有关所有 `ChatTogether` 功能和配置的详细文档，请前往 [API reference](https://reference.langchain.com/python/langchain-together/chat_models/ChatTogether)
