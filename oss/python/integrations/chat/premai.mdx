...
本示例介绍如何使用 LangChain 与 different 聊天模型 with `ChatPremAI`
...
First we start by defining our repository with some repository ids. Make sure that the IDs are valid repository IDs. 更多信息，请参阅 [how to get the repository ID](https://docs.premai.io/get-started/repositories).
...
With **Prem**, writing and managing prompts can be super easy. The **_Templates_** tab inside the [launchpad](https://docs.premai.io/get-started/launchpad) helps you write as many prompts as you need and use it inside the SDK to make your application run using those prompts. 更多信息，请参阅 [Prem Prompt Templates](https://docs.premai.io/get-started/prem-templates).
...
Now, we can bind them to 聊天模型 and directly get the result:
