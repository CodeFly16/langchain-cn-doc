...
本示例介绍如何使用 LangChain 与 Eden AI models
...
For more information and details about Eden AI, 查看 this link: : [docs.edenai.co/docs/additional-parameters](https://docs.edenai.co/docs/additional-parameters)
...
The BaseChatModel.with_structured_output interface makes it easy to get structured output from 聊天模型. You can use ChatEdenAI.with_structured_output, which uses tool-calling under the hood), to get the model to more reliably return an output in a specific format:
