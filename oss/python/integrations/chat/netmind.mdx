...
本指南将帮助您开始使用 Netmind [聊天模型](https://www.netmind.ai/). 有关所有 `ChatNetmind` 功能和配置的详细文档，请前往 [API reference](https://github.com/protagolabs/langchain-netmind).
...
有关所有 `ChatNetmind` 功能和配置的详细文档，请前往 API reference:
