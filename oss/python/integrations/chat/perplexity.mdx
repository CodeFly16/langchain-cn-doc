...
本页面将帮助您开始使用 Perplexity [聊天模型](/oss/python/langchain/models). 有关所有 `ChatPerplexity` 功能和配置的详细文档，请前往 [API reference](https://reference.langchain.com/python/langchain-perplexity/chat_models/ChatPerplexity).
...
前往 [this page](https://www.perplexity.ai/) 注册 Perplexity 并生成 API 密钥。 完成后设置 `PPLX_API_KEY` 环境变量：
