...
This doc helps you get started with Fireworks AI [聊天模型](/oss/python/langchain/models). For a list of all models served by Fireworks 请参阅 [Fireworks docs](https://fireworks.ai/models).

<Tip>
    **API 参考**

    有关所有 features and configuration options, 请前往 [`ChatFireworks`](https://reference.langchain.com/python/langchain-fireworks/chat_models/ChatFireworks) API reference.
</Tip>
...
前往 [fireworks.ai](https://app.fireworks.ai/login) 注册 Fireworks 并生成 API 密钥。 完成后设置 FIREWORKS_API_KEY 环境变量：
