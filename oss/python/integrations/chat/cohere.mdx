...
Head to the [API reference](https://reference.langchain.com/python/langchain-cohere/chat_models/ChatCohere) 查看所有属性和方法的详细文档。
...
We'll also need to get a [Cohere API key](https://cohere.com/) and set the `COHERE_API_KEY` 环境变量：
