...
本指南提供了开始使用 Cerebras [聊天模型](/oss/python/langchain/models). 有关所有 `ChatCerebras` 功能和配置的详细文档，请前往 [API reference](https://reference.langchain.com/python/langchain-cerebras/chat_models/ChatCerebras).
...
有关所有 `ChatCerebras` 功能和配置的详细文档，请前往 [API reference](https://reference.langchain.com/python/langchain-cerebras/chat_models/ChatCerebras)
