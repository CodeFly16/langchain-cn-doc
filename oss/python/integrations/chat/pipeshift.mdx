...
本指南将帮助您开始使用 Pipeshift [聊天模型](/oss/python/langchain/models/). 有关所有 `ChatPipeshift` 功能和配置的详细文档，请前往 [API reference](https://dashboard.pipeshift.com/docs).
...
要访问 Pipeshift 模型，您需要创建一个 account on Pipeshift, get an API key, and install the `langchain-pipeshift` 集成包。

### 凭证

前往 [Pipeshift](https://dashboard.pipeshift.com) 注册 Pipeshift 并生成 API 密钥。 完成后设置 PIPESHIFT_API_KEY 环境变量：
...
有关所有 `ChatPipeshift` 功能和配置的详细文档，请前往 API reference: [dashboard.pipeshift.com/docs](https://dashboard.pipeshift.com/docs)
