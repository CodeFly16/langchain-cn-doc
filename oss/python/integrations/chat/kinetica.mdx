---
title: "Kinetica language to SQL 集成"
description: "使用 LangChain Python 集成 Kinetica language to SQL 聊天模型。"
---
...
For this demo we will be using **SqlAssist**. 请参阅 [Kinetica Documentation
