...
description: "使用 LangChain Python 集成文件系统存储。"
---

这将帮助你开始使用 local filesystem [键值存储](/oss/python/integrations/stores)。 所有 `LocalFileStore` 功能和配置的详细文档请前往 [API reference](https://reference.langchain.com/python/langchain-classic/storage/file_system/LocalFileStore).
...
所有 `LocalFileStore` features and configurations, head to the [API reference](https://reference.langchain.com/python/langchain-classic/storage/file_system/LocalFileStore)
