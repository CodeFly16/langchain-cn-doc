---
title: "Jaguar vector database 集成"
description: "使用 LangChain Python 集成 Jaguar vector database 向量存储。"
---
...
3. 您需要使用 `pip install -qU langchain-community` 安装 `langchain-community` 来使用此集成
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/vectorstores/jaguar.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
