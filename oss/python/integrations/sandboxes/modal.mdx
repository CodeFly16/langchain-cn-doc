---
title: "Modal 沙箱"
description: "使用 LangChain Python 集成 Modal 沙箱。"
---

[Modal](https://modal.com) provides serverless container infrastructure with GPU support. 参见 [Modal docs](https://modal.com/docs) 了解注册、认证和平台详情。
