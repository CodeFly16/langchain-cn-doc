...
description: "使用 LangChain Python 集成 Hyperbrowser browser agent。"
---
...
To access the Hyperbrowser tools you'll need to install the `langchain-hyperbrowser` integration package, and create a Hyperbrowser account 并获取 API 密钥.
