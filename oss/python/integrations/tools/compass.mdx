...
description: "使用 LangChain Python 集成 the Compass defi toolkit。"
---
...
3. Pass the tools to your agent with `工具包。get_tools()`
...
To run these examples, ensure LangChain has access 提供自然语言接口 LLM service. For instance, if you're using GPT-4o, create a `.env` file containing:
