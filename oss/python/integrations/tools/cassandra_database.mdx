---
title: "Cassandra database toolkit 集成"
description: "使用 LangChain Python 集成 the Cassandra database toolkit。"
---
...
更多信息 on creating a Cassandra DB agent see the [CQL agent cookbook](https://github.com/langchain-ai/langchain/blob/v0.3/cookbook/cql_agent.ipynb)
...
- Pass the tools to your agent with `工具包。get_tools()`
