...
[工具](/oss/python/langchain/tools)是设计为由模型调用的实用程序：其输入由模型生成，输出传回给模型。

工具包是一组设计为一起使用的工具。

## 搜索

下表展示了 以某种形式执行在线搜索的工具:
...
<Info>
    如果你想贡献集成，请参阅 [贡献集成](/oss/python/contributing#add-a-new-integration)。
</Info>
