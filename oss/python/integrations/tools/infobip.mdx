---
title: "Infobip 集成"
description: "使用 LangChain Python 集成 Infobip。"
---

This notebook that shows how to use [Infobip](https://www.infobip.com/) API wrapper to send SMS messages, emails.

Infobip provides many services, but this notebook will focus on SMS and Email services. 更多信息, see [API and other channels](https://www.infobip.com/docs/api).
