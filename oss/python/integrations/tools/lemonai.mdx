...
description: "使用 LangChain Python 集成 Lemon agent。"
---
...
The following quick start 演示如何 use Lemon AI in combination with Agents to automate workflows that involve interaction with internal tooling.
...
Lemon AI automatically solves given tasks by finding the right combination of relevant tools or uses Lemon AI Functions as an alternative. 以下示例 演示如何 retrieve a user from Hackernews and write it to a table in Airtable:
