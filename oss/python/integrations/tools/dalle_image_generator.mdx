---
title: "Dall-e image generator 集成"
description: "使用 LangChain Python 集成 Dall-e image generator。"
---

>[OpenAI Dall-E](https://openai.com/dall-e-3) are text-to-image models developed by OpenAI using deep learning methodologies to generate digital images from 自然语言 descriptions, called "prompts".
