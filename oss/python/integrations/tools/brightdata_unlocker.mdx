...
description: "使用 LangChain Python 集成 Brightdataunlocker。"
---
...
You'll need a Bright Data API key to use this 工具。 You can set it as an environment variable:
...
Here we show how to instantiate an instance of the BrightDataUnlocker 工具。 This tool allows you to access websites that may be protected by anti-bot measures, geo-restrictions, or other access limitations using Bright Data's Web Unlocker service.
