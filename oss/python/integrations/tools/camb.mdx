---
title: "CAMB AI 集成"
description: "使用 LangChain Python 集成 CAMB AI multilingual audio and localization tools。"
---
...
To access the CAMB AI tools, you'll need to create a CAMB AI account 并获取 API 密钥 from [camb.ai](https://camb.ai).
...
所有 CAMB AI features and configurations, head to the [CAMB AI API reference](https://docs.camb.ai).
