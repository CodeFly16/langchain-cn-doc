---
title: "Slack toolkit 集成"
description: "使用 LangChain Python 集成 the Slack toolkit。"
---

这将帮助你开始使用 the Slack [toolkit](/oss/python/integrations/tools/slack). 所有 `SlackToolkit` 功能和配置的详细文档请前往 [API reference](https://reference.langchain.com/python/langchain-community/agent_toolkits/slack/toolkit/SlackToolkit).
...
所有 `SlackToolkit` 功能和配置的详细文档请前往 [API reference](https://reference.langchain.com/python/langchain-community/agent_toolkits/slack/toolkit/SlackToolkit).
