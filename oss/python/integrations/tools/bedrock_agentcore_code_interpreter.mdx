...
description: "使用 LangChain Python 集成 Amazon Bedrock agentcore code interpreter。"
---

[Amazon Bedrock AgentCore Code Interpreter](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/code-interpreter-工具。html) enables agents to execute code in secure, managed sandbox environments. Agents can run Python, JavaScript, and TypeScript code for calculations, data analysis, file manipulation, and visualizations.
...
| [Returns artifact](/oss/python/langchain/tools) | Native async | Return data | 定价 |
|:-----------------------------------------------:|:------------:|:-----------:|:-------:|
...
You need AWS credentials configured with permissions for Bedrock AgentCore Code Interpreter. 参见 [Amazon Bedrock AgentCore documentation](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/what-is-bedrock-agentcore.html) for required IAM permissions.
