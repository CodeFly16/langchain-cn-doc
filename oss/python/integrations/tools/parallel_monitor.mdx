...
description: "使用 LangChain Python 集成 the ParallelMonitor type。"
---
...
详细文档, head to the [`ParallelMonitor`](https://reference.langchain.com/python/langchain-parallel/monitors/ParallelMonitor) API reference or the [Monitor API guides](https://docs.parallel.ai/monitor-api/monitor-quickstart).
