...
We can use the Nimble search 工具与 an agent to give it dynamic web search capabilities. Here's a complete example using LangGraph:
...
所有 `NimbleSearchRetriever` features and configurations, visit the [Nimble API documentation](https://docs.nimbleway.com/nimble-sdk/search-api).
