---
title: "Steam toolkit 集成"
description: "使用 LangChain Python 集成 the Steam toolkit。"
---

>[Steam (Wikipedia)](https://en.wikipedia.org/wiki/Steam_(service)) 是由 `Valve Corporation`. It provides game updates automatically for Valve's games, and expanded to distributing third-party titles. `Steam` offers various features, like game server matchmaking with Valve Anti-Cheat measures, social networking, and game streaming services.
