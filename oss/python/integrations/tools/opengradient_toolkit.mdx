...
description: "使用 LangChain Python 集成 OpenGradientToolkit。"
---

This notebook shows how to build tools using the OpenGradient 工具包。 This toolkit gives users the ability to create custom tools based on models and workflows on the [OpenGradient network](https://www.opengradient.ai/).
...
Use the built in `get_tools()` method to view a list of the available tools within the OpenGradient 工具包。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/tools/opengradient_工具包。mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
