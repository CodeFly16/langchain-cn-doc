...
You'll need a Nimble API key to use this 工具。 Sign up at [Nimble](https://www.nimbleway.com/) to 获取你的 API 密钥 and access their free trial.
...
We can use the Nimble extract 工具与 an agent to give it URL content extraction capabilities. Here's a complete example using LangGraph:
...
所有 `NimbleExtractTool` features and configurations, visit the [Nimble API documentation](https://docs.nimbleway.com/nimble-sdk/search-api/extract-api-quick-start).
