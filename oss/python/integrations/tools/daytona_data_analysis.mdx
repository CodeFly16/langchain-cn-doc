...
description: "使用 LangChain Python 集成 DaytonaDataAnalysisTool。"
---
...
<Warning>
Call `工具。close()` when you're finished with all data analysis tasks to properly clean up resources and avoid unnecessary usage.
</Warning>
...
所有 `DaytonaDataAnalysisTool` features and configurations, head to the [API reference](https://www.daytona.io/docs/en/langchain-data-analysis#10-api-reference).
