---
title: "Fmp data 集成"
description: "使用 LangChain Python 集成 Fmp data。"
---

Access financial market data through 自然语言 queries.

## 概述

The FMP (Financial Modeling Prep) LangChain integration provides a seamless way to access financial market data through 自然语言 queries. This integration offers two main components:

- `FMPDataToolkit`: Creates collections of tools based on 自然语言 queries
