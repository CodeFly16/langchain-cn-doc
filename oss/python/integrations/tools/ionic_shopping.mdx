...
description: "使用 LangChain Python 集成 Ionic shopping。"
---
...
This is a basic jupyter notebook demonstrating how to integrate the Ionic Tool into your agent. 更多信息 on setting up your Agent with Ionic, see the Ionic [documentation](https://docs.ioniccommerce.com/introduction).

This Jupyter Notebook 演示如何 use the Ionic 工具与 an Agent.

**注意： The ionic-langchain package is maintained by the Ionic Commerce team, not the LangChain maintainers.**
