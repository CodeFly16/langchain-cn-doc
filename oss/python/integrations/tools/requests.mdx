---
title: "Requests toolkit 集成"
description: "使用 LangChain Python 集成 the Requests toolkit。"
---

We can use the Requests [toolkit](/oss/python/integrations/tools/requests) to construct agents that generate HTTP requests.

所有 API toolkit 功能和配置的详细文档请前往 API reference for [RequestsToolkit](https://reference.langchain.com/python/langchain-community/agent_toolkits/openapi/toolkit/RequestsToolkit).
...
Next we can instantiate the 工具包。 We require no authorization or other headers for this API:
