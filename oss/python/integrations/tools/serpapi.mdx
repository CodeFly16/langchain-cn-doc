---
title: "SerpAPI 集成"
description: "使用 LangChain Python 集成 SerpAPI。"
---

本 notebook 介绍如何使用 [SerpApi](https://serpapi.com/) component to search the web.
...
You can also customize the SerpAPI wrapper with arbitrary parameters. 例如, in the below example we will use `bing` instead of `google`.
