---
title: "Google jobs 集成"
description: "使用 LangChain Python 集成 Google jobs。"
---

本 notebook 介绍如何使用 Google Jobs Tool to fetch current Job postings.

First, you need to 注册 an `SerpApi key` key at: [serpapi.com/users/sign_up](https://serpapi.com/users/sign_up) and get your api key here: [serpapi.com/manage-api-key](https://serpapi.com/manage-api-key).
