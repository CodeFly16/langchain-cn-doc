---
title: "Wikipedia 集成"
description: "使用 LangChain Python 集成 Wikipedia。"
---

>[Wikipedia](https://wikipedia.org/) 是一个由志愿者社区编写和维护的多语言免费在线百科全书, 这些志愿者被称为维基百科人，他们通过开放协作并使用名为 MediaWiki 的基于 Wiki 的编辑系统. `Wikipedia` 是历史上最大和阅读量最多的参考工具书。
