---
title: "Prolog 集成"
description: "使用 LangChain Python 集成 Prolog。"
---
...
### Using a prolog 工具与 an LLM and function calling
...
### Using a prolog 工具与 an agent

To use the prolog 工具与 an agent, pass it to the agent's constructor:
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/tools/prolog_工具。mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
