...
获取你的 API 密钥 from the [cloro dashboard](https://dashboard.cloro.dev) and set it as an environment variable:
...
更多详情, visit the [cloro documentation](https://docs.cloro.dev).
