...
description: "使用 LangChain Python 集成 Oracle AI vector search generate summary。"
---
...
This guide 演示如何 generate document summaries using `OracleSummary` from the Oracle AI Vector Search LangChain integration.
...
***注意：*** The users may need to set proxy if they want to use some 3rd party summary generation providers other than Oracle's in-house and default provider: 'database'. If you don't have proxy, please remove the proxy parameter when you instantiate the OracleSummary.
