...
description: "使用 LangChain Python 集成 ParallelExtractTool。"
---
...
详细文档, head to the [`ParallelExtractTool`](https://reference.langchain.com/python/langchain-parallel/extract_tool/ParallelExtractTool) API reference or the [Parallel Extract reference](https://docs.parallel.ai/api-reference/extract/extract).
