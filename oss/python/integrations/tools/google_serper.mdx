...
description: "使用 LangChain Python 集成 Google Serper。"
---

本 notebook 介绍如何使用 `Google Serper` component to search the web. First you need 注册免费账户 at [serper.dev](https://serper.dev) and get your api key.
