...
Create an account at [ScraperAPI](https://www.scraperapi.com/) 并获取 API 密钥:
...
这是一个示例 of using the tools in an AI agent. The `ScraperAPITool` gives the AI the ability to browse any website, summarize articles, and click on links to navigate between pages.
