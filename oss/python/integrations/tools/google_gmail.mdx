...
description: "使用 LangChain Python 集成 the Gmail toolkit。"
---

这将帮助你开始使用 the Gmail [toolkit](/oss/python/integrations/tools/google_gmail). This toolkit interacts with the Gmail API to read messages, draft and send messages, and more. 所有 `GmailToolkit` 功能和配置的详细文档请前往 [API reference](https://reference.langchain.com/python/langchain-google-community/gmail/toolkit/GmailToolkit).
...
Below we show how to incorporate the toolkit in提供自然语言接口 [agent](/oss/python/langchain/agents).
...
所有 `GmailToolkit` 功能和配置的详细文档请前往 [API reference](https://reference.langchain.com/python/langchain-community/agent_toolkits/gmail/toolkit/GmailToolkit).
