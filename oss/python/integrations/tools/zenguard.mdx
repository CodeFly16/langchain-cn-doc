...
description: "使用 LangChain Python 集成 Zenguard AI。"
---
...
- `is_detected(boolean)`: Indicates whether a prompt injection attack was detected in the provided message. 在此示例中, it is False.
- `score(float: 0.0 - 1.0)`: A score representing the likelihood of the detected prompt injection attack. 在此示例中, it is 0.0.
