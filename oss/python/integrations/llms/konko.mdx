---
title: "Konko 集成"
description: "使用 LangChain Python 集成 Konko 大语言模型 (LLM)。"
---
...
本示例介绍如何使用 LangChain 与 `Konko` completion [models](https://docs.konko.ai/docs/list-of-models#konko-hosted-models-for-completion)
