---
title: "Javelin AI gateway tutorial 集成"
description: "使用 LangChain Python 集成 Javelin AI gateway tutorial 大语言模型 (LLM)。"
---
...
Before we begin, we must install the `javelin_sdk` and set up the Javelin API key as an 环境变量。
