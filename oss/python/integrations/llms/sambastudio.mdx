...
description: "使用 LangChain Python 集成 SambaStudio 大语言模型 (LLM)。"
---

<Warning>
**您当前所在的页面介绍的是 SambaStudio models as text completion models. We recommend you to use the [chat completion models](/oss/python/langchain/models).**
...
本示例介绍如何使用 LangChain 与 SambaStudio models
...
有关所有 `SambaStudio` llm 功能和配置的详细文档，请前往 [API reference]nce.langchain.com/python/langchain-community/llms/sambanova/SambaStudio)
