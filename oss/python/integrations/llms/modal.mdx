---
title: "Modal 集成"
description: "使用 LangChain Python 集成 Modal 大语言模型 (LLM)。"
---
...
本示例介绍如何使用 LangChain 与 a `modal` HTTPS [web endpoint](https://modal.com/docs/guide/webhooks).
...
* See Modal's [web endpoints](https://modal.com/docs/guide/webhooks#passing-arguments-to-web-endpoints) guide for the basics of setting up an endpoint that fulfils this 接口。
