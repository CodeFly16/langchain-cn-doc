...
description: "使用 LangChain Python 集成 OpaquePrompts 大语言模型 (LLM)。"
---
...
例如， if the original text says "Giana is good," it will be changed
...
* Please don't invent new masked terms. 例如， if you see "PERSON_998,"
