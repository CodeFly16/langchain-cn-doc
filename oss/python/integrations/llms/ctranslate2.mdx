...
description: "使用 LangChain Python 集成 Ctranslate2 大语言模型 (LLM)。"
---
...
Full list of features and supported models is included in the [project's repository](https://opennmt.net/CTranslate2/guides/transformers.html). To start, please 查看 the official [quickstart guide](https://opennmt.net/CTranslate2/quickstart.html).
