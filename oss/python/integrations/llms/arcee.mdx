---
title: "Arcee 集成"
description: "使用 LangChain Python 集成 Arcee 大语言模型 (LLM)。"
---
...
Before using Arcee, make sure the Arcee API key is set as `ARCEE_API_KEY` 环境变量。 You can also pass the api key as a named parameter.
