---
title: "Eden AI 集成"
description: "使用 LangChain Python 集成 Eden AI 大语言模型 (LLM)。"
---
...
要访问 a specific model, you can simply add 'model' during instantiation.

例如， let's explore the models provided by OpenAI, such as GPT3.5
