---
title: "Pipeshift 集成"
description: "使用 LangChain Python 集成 Pipeshift 大语言模型 (LLM)。"
---

本指南将帮助您开始使用 Pipeshift completion models (LLMs) using LangChain. For detailed documentation on `Pipeshift` 功能和配置选项的详细文档，请参阅 [API reference](https://dashboard.pipeshift.com/docs).
...
有关所有 `Pipeshift` 功能和配置的详细文档，请前往 API reference: [dashboard.pipeshift.com/docs](https://dashboard.pipeshift.com/docs)
