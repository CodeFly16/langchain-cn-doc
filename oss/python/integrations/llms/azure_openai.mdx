...
description: "使用 LangChain Python 集成 Azure OpenAI 大语言模型 (LLM)。"
---

<Warning>
**您当前所在的页面介绍的是 Azure OpenAI 文本补全模型。最新和最流行的 Azure OpenAI models are [chat completion models](/oss/python/langchain/models).**

除非您特别使用 `gpt-3.5-turbo-instruct`, 您可能需要查看 [此页面](/oss/python/integrations/chat/azure_chat_openai/).
</Warning>
