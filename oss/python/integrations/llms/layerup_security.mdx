...
description: "使用 LangChain Python 集成 Layerup security 大语言模型 (LLM)。"
---
...
Next, create a project 通过 [dashboard](https://dashboard.uselayerup.com), and copy your API key. We recommend putting your API key in your project's environment.
