---
title: "IPEX-LLM 集成"
description: "使用 LangChain Python 集成 IPEX- 大语言模型 (LLM)。"
---
...
本示例介绍如何使用 LangChain 与 `ipex-llm` for text generation on Intel GPU.
...
本示例介绍如何使用 LangChain 与 `ipex-llm` for text generation on Intel CPU.
