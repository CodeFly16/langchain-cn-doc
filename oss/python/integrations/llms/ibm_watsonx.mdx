...
description: "使用 LangChain Python 集成 IBM watsonx.ai 大语言模型 (LLM)。"
---
...
有关所有 `WatsonxLLM` 功能和配置的详细文档，请前往 [API reference](https://reference.langchain.com/python/integrations/langchain_ibm/WatsonxLLM/).
