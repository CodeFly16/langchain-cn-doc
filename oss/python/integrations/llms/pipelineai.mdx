---
title: "PipelineAI 集成"
description: "使用 LangChain Python 集成 PipelineAI 大语言模型 (LLM)。"
---

>[PipelineAI](https://pipeline.ai) allows you to run your ML models at scale in the cloud. It also 提供对 [several LLM models](https://pipeline.ai).
