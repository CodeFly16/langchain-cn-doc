---
title: "Predibase 集成"
description: "使用 LangChain Python 集成 Predibase 大语言模型 (LLM)。"
---
...
You'll also need to install the Predibase Python 包中：
...
```python
# 可选ly use `kwargs` to dynamically overwrite "generate()" settings.
