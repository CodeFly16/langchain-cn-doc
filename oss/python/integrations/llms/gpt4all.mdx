---
title: "Gpt4all 集成"
description: "使用 LangChain Python 集成 Gpt4all 大语言模型 (LLM)。"
---
...
本示例介绍如何使用 LangChain 与 `GPT4All` models.
...
This integration does not yet support streaming in chunks 通过 [`.stream()`](https://python.langchain.com/docs/how_to/streaming/) method. The below example uses a callback handler with `streaming=True`:
...
# Streamed tokens will be logged/aggregated 通过 passed callback
