---
title: "Databricks 集成"
description: "使用 LangChain Python 集成 Databricks 大语言模型 (LLM)。"
---

> [Databricks](https://www.databricks.com/) Lakehouse Platform unifies data, analytics, and AI on one platform.

本指南提供了开始使用 Databricks [LLM models](https://python.langchain.com/docs/concepts/text_llms). 有关所有 功能和配置的详细文档，请前往 [API reference](https://reference.langchain.com/python/langchain-community/llms/databricks/Databricks).
