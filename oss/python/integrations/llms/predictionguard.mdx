...
description: "使用 LangChain Python 集成 Predictionguard 大语言模型 (LLM)。"
---
...
要访问 Prediction Guard models, [contact Prediction Guard](https://predictionguard.com/get-started) to get an API key and get started.
...
With Prediction Guard, you can guard your model inputs for PII or prompt injections using one of our input checks. 请参阅 [Prediction Guard docs](https://docs.predictionguard.com/docs/process-llm-input/) for more information.
...
With Prediction Guard, you can check validate the model outputs using factuality to guard against hallucinations and incorrect info, and toxicity to guard against toxic responses (e.g. profanity, hate speech). 请参阅 [Prediction Guard docs](https://docs.predictionguard.com/docs/validating-llm-output) for more information.
