---
title: "Bigquery callback handler 集成"
...
These events track the raw requests sent 提供自然语言接口d responses received from the LLM.
...
If you are offloading images to GCS, you can use BigQuery ML 提供自然语言接口alyze them directly.
...
<Note>
  **Conversational Analytics**
  ...
  You can also use [BigQuery Conversational Analytics](https://cloud.google.com/bigquery/docs/conversational-analytics) 提供自然语言接口alyze your agent logs using 自然语言.
...
以下示例s demonstrate various features of the BigQuery callback handler:
