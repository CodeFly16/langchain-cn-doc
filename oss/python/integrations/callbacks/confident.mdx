---
title: "Confident 集成"
description: "使用 LangChain Python 集成 Confident。"
---

>[DeepEval](https://confident-ai.com) 包用于对 LLM 进行单元测试。
> Using Confident, 每个人都可以通过更快的迭代来构建健壮的语言模型
> 同时使用单元测试和集成测试。 我们为迭代中的每个步骤提供支持
> 从合成数据创建到测试。

在本指南中，我们将演示如何测试和衡量 LLM 的性能。 我们展示如何使用我们的回调来衡量性能，以及如何定义自己的指标并将其记录到我们的仪表板中。
...
Once you have ran that, you should be able to 请参阅我们的 dashboard below.
...
We can start by defining a simple chain 如下所示.
