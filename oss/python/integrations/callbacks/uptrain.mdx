---
title: "Uptrain 集成"
description: "使用 LangChain Python 集成 Uptrain。"
---
...
**注意：** The `project_name` will be the project name under which the evaluations performed will be shown in the UpTrain dashboard.
