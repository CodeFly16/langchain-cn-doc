...
description: "使用 LangChain Python 集成 PromptLayer。"
---
...
See [PromptLayer docs](https://docs.promptlayer.com/languages/langchain) 了解更多信息。
...
在此示例中, we unlock more of the power of `PromptLayer`.
...
We also define a `pl_id_callback` function which takes in the `promptlayer_request_id` and logs a score, metadata and links the prompt template used. 阅读更多关于 tracking on [our docs](https://docs.promptlayer.com/features/prompt-history/request-id).
