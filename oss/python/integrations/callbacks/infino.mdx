---
title: "Infino 集成"
description: "使用 LangChain Python 集成 Infino。"
---
...
此示例展示 how one can track the following while calling OpenAI and ChatOpenAI models via `LangChain` and [Infino](https://github.com/infinohq/infino):
