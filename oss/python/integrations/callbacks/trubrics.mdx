---
title: "Trubrics 集成"
description: "使用 LangChain Python 集成 Trubrics。"
---
...
If you do not have a Trubrics account, [create one on Trubrics](https://trubrics.streamlit.app/). 在本教程中, we will use the `default` project that is built upon account creation.
