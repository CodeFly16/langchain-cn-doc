---
title: "Tencent cos file 集成"
description: "使用 LangChain Python 集成 Tencent cos file 文档加载器。"
---
...
本文介绍如何load document object from a `Tencent COS File`.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/tencent_cos_file.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
