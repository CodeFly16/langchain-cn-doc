...
更多详情请参阅 the [Soniox language hints documentation](https://soniox.com/docs/stt/concepts/language-hints).
...
更多详情请参阅 the [Soniox context documentation](https://soniox.com/docs/stt/concepts/context).
...
You can also transcribe and translate between two languages simultaneously using `two_way` translation type. 更多信息请参阅 [async translation](https://soniox.com/docs/stt/async/async-translation).
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/soniox.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
