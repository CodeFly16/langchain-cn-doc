---
title: "YouTube audio 集成"
description: "使用 LangChain Python 集成 YouTube audio 文档加载器。"
---
...
注意：You will need to have an `OPENAI_API_KEY` supplied.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/youtube_audio.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
