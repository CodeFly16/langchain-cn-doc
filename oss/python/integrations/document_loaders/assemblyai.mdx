---
title: "AssemblyAI audio transcripts 集成"
description: "使用 LangChain Python 集成 AssemblyAI audio transcripts 文档加载器。"
---
...
你也可以指定the `config` argument to use different audio intelligence models.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/assemblyai.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
