...
此加载器allows you to provide the board name to pull in the corresponding cards into Document objects.
...
你也可以指定several load parameters to include / remove different fields both from the document page_content properties and metadata.
...
默认情况下，all card fields are included for the full text page_content and metadata accordingly.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/trello.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
