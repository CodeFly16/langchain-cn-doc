---
title: "HuggingFace dataset 集成"
description: "使用 LangChain Python 集成 HuggingFace dataset 文档加载器。"
---
...
本 notebook 展示how to load `Hugging Face Hub` datasets to LangChain.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/hugging_face_dataset.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
