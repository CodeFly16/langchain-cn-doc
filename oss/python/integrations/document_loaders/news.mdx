---
title: "News URL 集成"
description: "使用 LangChain Python 集成 News URL 文档加载器。"
---

本文介绍如何load HTML news articles from a list of URLs into a document format that we can use downstream.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/news.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
