...
本 notebook 展示how to load wiki pages from `wikipedia.org` into the Document format that we use downstream.

## 安装

首先，你需要安装 `langchain_community` and `wikipedia` packages.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/wikipedia.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
