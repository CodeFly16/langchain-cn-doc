---
title: "Airbyte salesforce (Deprecated) 集成"
description: "使用 LangChain Python 集成 Airbyte salesforce (Deprecated) 文档加载器。"
---
...
此加载器将 Salesforce 连接器作为文档加载器公开，允许你将各种 Salesforce 对象加载为文档。
...
查看 [Airbyte documentation page](https://docs.airbyte.com/integrations/sources/salesforce/) 以获取有关如何配置读取器的详细信息。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/airbyte_salesforce.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
