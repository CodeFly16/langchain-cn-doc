...
本 notebook 介绍如何load documents from `Docugami`. It provides the advantages of using this system over alternative data loaders.
...
我们可以use a self-querying retriever to improve our query accuracy, using this additional metadata:
