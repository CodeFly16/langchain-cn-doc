---
title: "Cube semantic layer 集成"
description: "使用 LangChain Python 集成 Cube semantic layer 文档加载器。"
---

本 notebook 演示the process of retrieving Cube's data model metadata in a format suitable for passing to LLMs as embeddings, thereby enhancing contextual information.
