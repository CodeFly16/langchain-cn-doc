---
title: "Images 集成"
description: "使用 LangChain Python 集成 Images 文档加载器。"
---

本文介绍如何load images into a document format that we can use downstream with other LangChain modules.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/image.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
