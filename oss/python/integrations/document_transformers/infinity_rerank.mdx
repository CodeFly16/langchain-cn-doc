...
description: "使用 LangChain Python 集成 Infinity reranker 文档转换器。"
---
...
本 notebook 展示how to use Infinity Reranker for document compression and retrieval.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_transformers/infinity_rerank.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
