---
title: "Doctran extract properties 集成"
description: "使用 LangChain Python 集成 Doctran extract properties 文档转换器。"
---

我们可以extract useful features of documents using the [Doctran](https://github.com/psychic-api/doctran) library, which uses OpenAI's function calling feature to extract specific metadata.
...
这是we'll extract properties from.的文档
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_transformers/doctran_extract_properties.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
