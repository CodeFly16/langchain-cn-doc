...
此示例介绍如何use AI21SemanticTextSplitter in LangChain.
...
此示例展示如何use AI21SemanticTextSplitter to split a text into chunks based on semantic meaning.
...
此示例展示如何use AI21SemanticTextSplitter to split a text into chunks based on semantic meaning, then merging the chunks based on `chunk_size`.
...
此示例展示如何use AI21SemanticTextSplitter to split a text into Documents based on semantic meaning. The metadata will contain a type for each document.
...
此示例展示如何use AI21SemanticTextSplitter to create Documents from texts, and adding custom Metadata to each Document.
...
此示例展示如何use AI21SemanticTextSplitter to split a text into Documents based on semantic meaning. The metadata will contain a start index for each document.
...
此示例展示如何use AI21SemanticTextSplitter to split a list of Documents into chunks based on semantic meaning.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_transformers/ai21_semantic_text_splitter.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
