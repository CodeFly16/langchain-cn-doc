---
title: "Openvino reranker 集成"
description: "使用 LangChain Python 集成 Openvino reranker 文档转换器。"
---
...
可以export your rerank model to the OpenVINO IR format with `OVModelForSequenceClassification`, and load the model from local folder.
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_transformers/openvino_rerank.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
