---
title: "Rankllm reranker 集成"
description: "使用 LangChain Python 集成 Rankllm reranker 文档转换器。"
---
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_transformers/rankllm-reranker.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
