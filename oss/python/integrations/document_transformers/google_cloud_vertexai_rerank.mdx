...
description: "使用 LangChain Python 集成 Google cloud Vertex AI reranker 文档转换器。"
---
...
>更多信息请参阅 [Rank and rerank documents](https://cloud.google.com/generative-ai-app-builder/docs/ranking).
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_transformers/google_cloud_vertexai_rerank.mdx) 或 [提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
