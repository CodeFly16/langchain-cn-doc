---
title: "Kuzu 集成"
description: "使用 LangChain Python 集成 Kuzu。"
---
...
请注意 we set a temperature that's slightly higher than zero to avoid the LLM being overly concise in its response.
