---
title: "Jaguardb vector database 集成"
description: "使用 LangChain Python 集成 Jaguardb vector database 检索器。"
---
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/jaguar.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
