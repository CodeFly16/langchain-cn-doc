...
我们可以将其用作[检索器](/oss/python/langchain/retrieval)。 它将展示此集成特有的功能。 阅读完毕后，建议探索[相关用例页面](/oss/python/langchain/rag)以学习如何将此向量存储用作更大链的一部分。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/tavily.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
