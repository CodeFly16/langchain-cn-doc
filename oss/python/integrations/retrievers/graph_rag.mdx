---
title: "Graph RAG 集成"
description: "使用 LangChain Python 集成 Graph RAG 检索器。"
---
...
| 检索器 | 来源 | PyPI Package | Latest | Project Page |
| :--- | :--- | :---: | :---: | :---: |
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/graph_rag.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
