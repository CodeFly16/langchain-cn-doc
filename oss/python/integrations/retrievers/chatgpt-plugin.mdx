...
description: "使用 LangChain Python 集成 ChatGPT plugin 检索器。"
---
...
我们想要使用 `ChatGPTPluginRetriever`，所以需要获取 OpenAI API 密钥。
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/chatgpt-plugin.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
