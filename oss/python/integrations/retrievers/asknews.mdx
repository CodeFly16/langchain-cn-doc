---
title: "Asknews 集成"
description: "使用 LangChain Python 集成 Asknews 检索器。"
---
...
It's also helpful (but not needed) to set up [LangSmith](https://smith.langchain.com?utm_source=docs&utm_medium=cta&utm_campaign=langsmith-signup&utm_content=oss-python-integrations-retrievers-asknews) for best-in-class observability
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/asknews.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
