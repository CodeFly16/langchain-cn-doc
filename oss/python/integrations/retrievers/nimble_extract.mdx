...
我们可以将其用作[检索器](/oss/python/langchain/retrieval)。 它将展示此集成特有的功能。 After going through, it may be useful to explore [relevant use-case pages](/oss/python/langchain/rag) to learn how to use this retriever as part of a larger chain.
...
我们还需要设置 Nimble API 密钥。 You can obtain an API key by signing up at [Nimble](https://www.nimbleway.com/).
...
<Callout icon="edit">
    [在 GitHub 上编辑此页面](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/retrievers/nimble_extract.mdx)或[提交 issue](https://github.com/langchain-ai/docs/issues/new/choose)。
</Callout>
</div>
